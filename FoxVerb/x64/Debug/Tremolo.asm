...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?init@Tremolo@@QEAAXHW4OscillatorType@@MM@Z DD imagerel $LN4@init
	DD	imagerel $LN4@init+94
	DD	imagerel $unwind$?init@Tremolo@@QEAAXHW4OscillatorType@@MM@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$??0Tremolo@@QEAA@XZ DD imagerel $LN10@Tremolo
	DD	imagerel $LN10@Tremolo+110
	DD	imagerel $unwind$??0Tremolo@@QEAA@XZ
;	COMDAT xdata
xdata	SEGMENT
$unwind$??0Tremolo@@QEAA@XZ DQ 00007340a00040a01r ; 1.00174e-308
	DD	07006320aH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?init@Tremolo@@QEAAXHW4OscillatorType@@MM@Z DQ 00002681200061201r ; 3.34668e-309
